...
function wpstarter_setup() {
	...
	register_nav_menus( array(
		...
		'menu-2' => esc_html__( 'Secundary', 'wpstarter' ),
	) );
...
function wpstarter_scripts() {
	wp_enqueue_style( 'wpstarter-plugins-css', get_template_directory_uri() . '/dist/plugins.min.css' );

	wp_enqueue_style( 'wpstarter-style', get_stylesheet_uri() );

	wp_enqueue_script( 'wpstarter-site-js', get_template_directory_uri() . '/dist/site.min.js', array(), '', true );
